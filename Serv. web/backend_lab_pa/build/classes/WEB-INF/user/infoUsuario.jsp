...
<body>
    ...
    <main>
            ...
            <div class="container-md container-fluid">
               ...
               <div class="col-md-6 col-12 text-start">
				    ...
				    <form id="notificacionesForm" action="infoUsuario" method="POST">
						...
						<%= (cliente != null && cliente.getNotificaciones()) ? "checked" : "" %> >				        <label for="recibirNotificaciones">Recibir notificaciones</label>
	    ...
	    if (usuarioActual instanceof Proveedor) {
	    	...
	    	System.out.println("Lista de reclamos del proveedor antes d emeter en combo: ");
	    	for (Reclamo reclamo : proveedor.getReclamos()) {
	    	    System.out.println(reclamo); // Asumiendo que el método toString() esté correctamente implementado en Reclamo
	    	}
		%>
	        <section id="ver-orden-section">
	            <h2>Ver reclamos</h2>
	                    ...
	                    <div id="ver-orden-container">
	                        <div class="form-group d-flex align-items-center">
	                            <div class="mr-2 w-100">
	                                ...
	                                <%
                                    for (Reclamo reclamo : proveedor.getReclamos()) { // Asegúrate de que 'getOrdenes' retorne una lista de órdenes
	                                %>
	                                
	                                    <option value="<%= reclamo.getId() %>">Reclamo <%= reclamo.getId() %> - Fecha <%= reclamo.getFecha().getFechaEnFormatoInput() %></option>
	...
	<script>
		...
		function guardarNotificaciones(event) {
		    event.preventDefault();  // Evitar el envío default
