...
public class nuevoComentario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String estrellasCheck = String.valueOf(estrellasComentario);
            
            if(textoComentario.isEmpty() || textoComentario.equals("") || estrellasComentario == 0 || estrellasCheck.isEmpty() || estrellasCheck.equals("")) {
            	response.sendRedirect("home");
        		return;
            }
            ...
            if(producto != null && usuarioActualCliente != null) {
                ...
                port.agregarComentarioAProducto(producto.getNumReferencia(), usuarioActualCliente.getNickname(), textoComentario, estrellasComentario, "", 0);
