...
/**
 * <p>Clase Java para getImagenResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getImagenResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getImagenResponse", propOrder = {
    "_return"
})
public class GetImagenResponse {
